...
<template>
  <div class="flex w-full flex-col">
    ...
    <!-- Show locked message instead of editor when issue is locked -->
    <div
      v-if="isLocked"
      class="my-4 rounded-lg border border-gray-300 bg-gray-50 p-4 text-gray-600 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400"
    >
