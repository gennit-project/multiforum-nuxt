<script setup lang="ts">
  ...
  const showEditCommentForm = computed(() => {
    return !props.readonly && props.editFormOpenAtCommentID === props.commentData.id;
  });
...
<template>
  <div>
    <div
      class="flex w-full"
      :class="[depth > 1 ? 'ml-1 border-l border-gray-500 pl-4 pt-2 dark:border-gray-600' : '']"
    >
      <div
        class="w-full"
        :class="'text-sm'"
      >
        ...
        >
          <div class="w-full flex-col rounded-lg">
            ...
            />
            <div class="ml-4 flex-grow border-l border-gray-500 pl-4 dark:border-gray-600">
        ...
        <nuxt-link
          ...
          class="flex w-full cursor-pointer items-center gap-1 border-gray-500 pl-4 text-gray-400 underline dark:border-gray-500 dark:text-gray-300"
          :to="permalinkObject"
        ...
        <div
          ...
          id="childComments"
          class="ml-3 w-full border-gray-500 dark:border-gray-600"
        >
          <ChildComments
            v-slot="slotProps"
