...
<template>
  ...
  >
    <div class="relative mt-1">
      <ListboxButton
        class="focus:border-orange-500 focus:ring-orange-500 relative w-full cursor-default rounded-md border border-gray-300 bg-white pl-3 pr-10 text-left shadow-sm focus:outline-none focus:ring-1 dark:bg-gray-800 dark:text-gray-200"
