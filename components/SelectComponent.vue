...
<template>
  <Listbox v-model="selected" as="div" @update:model-value="handleSelect">
    <div class="relative mt-1">
      ...
      <ListboxOptions
        class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm dark:bg-gray-800 dark:text-gray-200"
      >
        <ListboxOption
