...
const disabledDownloadButtonClasses = `${buttonBaseClasses} cursor-default bg-gray-200 text-gray-300 dark:bg-gray-800 dark:text-gray-300`;
</script>
...
<template>
  <button
    type="button"
    :class="
      disabled ? disabledDownloadButtonClasses : activeDownloadButtonClasses
    "
    :disabled="disabled"
  >
    {{ label }}
