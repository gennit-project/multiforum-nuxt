<script setup lang="ts">
  ...
  const emit = defineEmits(["updateFormValues", "setSelectedChannels", "submit", "file-change"]);
  ...
  const duration = computed(() => {
    return getDuration(startTime.value.toISOString(), endTime.value.toISOString());
  });
  ...
  <div class="mx-auto max-w-3xl px-2 pt-0 dark:text-white sm:px-6">
    ...
    >
      ...
      <div class="w-full space-y-5">
        ...
        <FormRow :required="true">
          <template #content>
            <ForumPicker
              ...
              @set-selected-channels="emit('updateFormValues', { selectedChannels: $event })"
            />
          </template>
        </FormRow>
        <FormRow :required="true">
          <template #content>
            <div
              class="flex flex-wrap items-center gap-2 rounded-md border border-black p-2 dark:border-gray-600"
            >
        ...
        <FormRow v-if="selectedEventType === 'virtual' || selectedEventType === 'hybrid'">
          <template #content>
            <TextInput
              id="virtualEventUrl"
              :full-width="true"
        ...
        <FormRow>
          <template #content>
            ...
            >
              <div
                class="relative overflow-hidden rounded-md border border-black dark:border-gray-600"
              >
                <img
                  alt="Cover Image"
              ...
              <div class="mt-2 flex space-x-2">
                ...
                <button
                  ...
                  :class="{ 'cursor-not-allowed opacity-60': coverImageLoading }"
                  :disabled="coverImageLoading"
                  type="button"
            ...
            <div
              ...
              class="bg-gray-50 mb-3 rounded-md border border-black p-6 dark:border-gray-600 dark:bg-gray-700"
            >
              <div
            ...
            >
              <div
                class="bg-gray-50 rounded-md border border-dashed border-black p-8 text-center dark:border-gray-600 dark:bg-gray-800"
              >
