  ...
  <div class="flex-1 dark:text-white">
    ...
    <div class="relative flex items-center">
      ...
      <input
        v-model="searchQuery"
        :autofocus="autoFocus"
        class="h-10 w-full border border-gray-500 bg-white py-3 pl-10 pr-3 text-sm leading-5 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
        :class="[
