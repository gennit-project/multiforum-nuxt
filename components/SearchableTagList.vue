...
<template>
  <div
    class="touch-scroll-y absolute left-0 right-0 top-full z-10 max-h-60 w-full overflow-y-auto rounded-md border border-black bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:text-white"
  >
    <SearchBar
      :auto-focus="true"
    ...
    >
      <label class="flex cursor-pointer items-center space-x-3 p-2">
        <input
          ...
          class="border border-black text-blue-600 dark:border-gray-600"
          type="checkbox"
          :value="tag.text"
