...
<template>
  ...
  >
    ...
    <div
      ...
      class="overlay-shade fixed left-0 top-0 flex h-full w-[275px] flex-col justify-between overflow-y-auto border-gray-500 bg-white py-2 dark:border-gray-500 dark:bg-gray-900"
    >
      <div>
      ...
      <div
        ...
        class="border-t border-gray-500 dark:border-gray-600"
      >
        <div
            ...
            >
              ...
              >
                <AvatarComponent
                  ...
                  class="list-item-icon border-1 h-8 w-8 shrink-0 border-gray-500 shadow-sm dark:border-gray-800"
                  :is-small="true"
                  :is-square="false"
