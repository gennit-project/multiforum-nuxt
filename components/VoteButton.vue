<script lang="ts" setup>
  ...
  const buttonClasses = computed(() => {
    ...
    const defaultClasses = properties.active
      ...
      : "border-gray-500 bg-gray-100 text-black hover:border-blue-400 hover:bg-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600";
