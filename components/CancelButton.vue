...
<template>
  <GenericButton
    class="hover:bg-gray-50 rounded-full border border-black px-4 py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
    :class="[
