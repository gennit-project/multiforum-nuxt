<script lang="ts" setup>
  ...
  import { MARK_AS_ANSWERED, MARK_AS_UNANSWERED } from "@/graphQLData/discussion/mutations";
...
<template>
  <div>
    <button
      v-if="!answered"
      class="align-items flex gap-1 rounded-full border border-black px-2 py-1 text-xs hover:bg-gray-200 dark:border-gray-600 dark:text-white dark:hover:bg-gray-700"
