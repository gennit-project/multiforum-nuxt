<script setup lang="ts">
  ...
  const updateCommentSectionQueryResult = (input: CommentSectionQueryUpdateInput) => {
    const { cache, commentToDeleteId, commentToAddFeedbackTo, newFeedbackComment } = input;
