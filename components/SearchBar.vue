...
<template>
  <div class="flex h-full flex-1 items-center justify-center">
    <div class="relative flex w-full items-center">
      ...
      <input
        ref="searchInputRef"
        class="w-full border border-gray-500 pl-10 pr-12 text-sm leading-5 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-400"
        :class="[
