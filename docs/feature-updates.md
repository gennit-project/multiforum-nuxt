...
![download_list_with_filters_in_side_bar.png](assets/screenshots/download_list_with_filters_in_side_bar.png)

Applying the `Residential` filter updates results in place.

![one_active_filter.png](assets/screenshots/one_active_filter.png)

Applying two filters narrows results further (for example `Residential` + `20x20`).

![two_active_filters.png](assets/screenshots/two_active_filters.png)

These filters correspond to labels shown on each download detail page.

![labels_on_detail_page.png](assets/screenshots/labels_on_detail_page.png)

Filters are configured per forum in settings:

![filter_group_form1.png](assets/screenshots/filter_group_form1.png)

![filter_group_form2.png](assets/screenshots/filter_group_form2.png)
...
![marker clustering before - way too many markers](assets/screenshots/marker-clustering-before.png)

After:

![marker clustering after - much fewer markers](assets/screenshots/marker-clustering-after.png)
...
![one-page-wiki-example](assets/screenshots/one-page-wiki-example.png)

Multi-page wiki example:

![multiple-page-wiki-example](assets/screenshots/wiki-multiple-pages.png)

Editing a wiki page:

![edit wiki example](assets/screenshots/edit-wiki-example.png)

Fullscreen wiki editing:

![wiki edit fullscreen](assets/screenshots/wiki-edit-fullscreen.png)

Revision history view:

![wiki revision history](assets/screenshots/wiki-revision-history.png)

Diff view between revisions:

![wiki revision diff view](assets/screenshots/wiki-diff-view.png)
