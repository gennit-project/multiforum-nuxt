...
describe("Give feedback on a discussion", () => {
  ...
  it("can create/edit/delete feedback and permalink to it", () => {
    ...
    cy.get('div[data-testid="discussion-thumbs-down-menu-button-item-Give Feedback"]')
    ...
    cy.get('textarea[data-testid="description-input"]').type("This is a test feedback");
    // click submit
    ...
    cy.get('button[data-testid="downvote-discussion-button"]').should("have.class", "bg-blue-500");

    // EDIT FEEDBACK
    cy.get('button[data-testid="downvote-discussion-button"]').click();

    cy.get('div[data-testid="discussion-thumbs-down-menu-button-item-Edit Feedback"]')
      .first()
      .click();
    ...
    cy.get('div[data-testid="feedback-comment-menu-item-Copy Link"]').first().click();
    ...
    cy.get('button[data-testid="feedback-comment-menu"]').click();
    cy.get('div[data-testid="feedback-comment-menu-item-Delete"]').first().click();
