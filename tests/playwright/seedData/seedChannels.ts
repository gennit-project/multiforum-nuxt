...
const baseChannels: BaseChannel[] = [
  ...
  },
  {
    ...
    rules:
      '[{"summary":"Focus on music","detail":"Non-music-related content will be removed."}]',
  },
  {
  ...
  },
  {
    ...
    mods: ['testModProfile1'],
    rules:
      '[{"summary":"Share Sims 4 builds","detail":"Post your creative builds for The Sims 4 community."}]',
    ...
    filterGroups: [
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            displayName: 'Community Space',
            order: 8,
          },
          {
            value: 'foxbury_commons',
            displayName: 'Foxbury Commons',
            order: 9,
          },
          ...
          {
            value: 'onsen_bathhouse',
            displayName: 'Onsen Bathhouse',
            order: 20,
          },
      ...
      },
      {
        ...
        options: [
          {
            value: 'outdoor_retreat',
            displayName: 'Outdoor retreat',
            order: 0,
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: 'home_chef_hustle',
            displayName: 'Home Chef Hustle',
            order: 14,
          },
          {
