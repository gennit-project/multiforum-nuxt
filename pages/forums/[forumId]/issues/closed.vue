  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const closedIssues = computed<Issue[]>(() => {
        if (getClosedIssuesByChannelLoading.value || getClosedIssuesByChannelError.value) {
          return [];
        }
...
<template>
  <ul
    class="divide-y divide-gray-200 border-t border-gray-500 dark:divide-gray-800 dark:border-gray-800 dark:text-white"
